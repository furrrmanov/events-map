...
import { userLogOut } from 'src/client/actions'
import CustomLink from 'src/client/components/controls/RouterLink'
import { singOutUsingFirebase } from 'src/client/utils/fireBase'
import {
  ROUT_FOR_MAP_PAGE,
